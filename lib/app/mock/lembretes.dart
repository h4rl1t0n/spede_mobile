...
final lembretes = <LembreteModel>[
  LembreteModel(
    ...
    descricao:
        'Pauta de julgamentos da 15ª Sessão Ordinária do Tribunal Pleno. Apresentação de contas anuais de prefeituras do Cabinior.',
    tipo: 'Sessão',
    numero: '16210/2026',
  ...
  LembreteModel(
    ...
    descricao:
        'Apreciação de Recurso de Reconsideração Cabinposto contra o Acórdão 342/2025 que julgou irregular as contas.',
    tipo: 'Sessão',
    numero: '17250/2026',
  ...
  LembreteModel(
    ...
    descricao:
        'Vencimento do prazo legal para o gestor apresentar justificativas quanto às falhas apontadas no controle Cabinno.',
    tipo: 'Processo',
    numero: '13422/2026',
    assunto: 'Denúncia',
  ...
  LembreteModel(
    ...
    descricao:
        'Último dia para Cabinposição de recurso ordinário referente à Tomada de Contas Especial julgada irregular.',
    tipo: 'Prazo',
    numero: '14590/2026',
    assunto: 'Tomada de Contas Especial',
